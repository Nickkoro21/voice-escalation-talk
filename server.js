/* Minimal static server for offline preview of the deck.
   Root = presentation/ (parent of deck) so that ../assets resolves.
   No external deps. */
...
http.createServer((req, res) => {
  ...
  if (urlPath === '/' || urlPath === '') {
    res.writeHead(302, { Location: '/deck/index.html' });
    return res.end();
  }
